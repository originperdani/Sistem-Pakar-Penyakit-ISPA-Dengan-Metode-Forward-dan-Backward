...
if (empty($_SESSION['diagnose_result'])) {
    header('Location: index.php');
    exit;
}

$diagnose_result = $_SESSION['diagnose_result'];
// Clear session data to prevent stale data on refresh or back
unset($_SESSION['diagnose_result']);

$selected = $diagnose_result['selected'];
$matches = $diagnose_result['matches'];
$suggestions = $diagnose_result['suggestions'];
$diseases = $diagnose_result['diseases'];
?>
<!DOCTYPE html>
<html lang="id">
<head>
